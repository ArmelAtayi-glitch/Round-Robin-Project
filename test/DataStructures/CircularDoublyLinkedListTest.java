...
public class CircularDoublyLinkedListTest {
    ...
    public void testAddAfter() throws Exception {
        ...
        try {
            assertEquals(circle.getNode(0).getElement().intValue(), 10);
            assertEquals(circle.getNode(10).getElement().intValue(), 17);
        } 
        catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    public void testRemove2() throws Exception {
       ...
       CircularDoublyLinkedList<Integer> circle = new CircularDoublyLinkedList<Integer>();
       //circle.removeLast();
      // Exception exTest = assertThrows(EmptyCollectionException.class,()-> {circle.remove(4);});
       //assertThrows();

        assertEquals(0,circle.size());
        try {
           // assertThrows(ElementNotFoundException.class,()-> circle.remove(2));
        ...
        try {
            assertEquals(10,circle.getNode(0).getElement().intValue());
            assertEquals(10,circle.current().intValue());
            circle.remove(20);
        } 
        catch (Exception ex){
            ex.printStackTrace();
...
/**
    ...
    public void testSet3() throws Exception {
        ...
        assertEquals(circle.get(1).intValue(),18);
        assertEquals(circle.get(2).intValue(),55);
        ...
        assertEquals(circle.current().intValue(),55);
        circle.set(2, 57);
        assertEquals(circle.get(0).intValue(),57);
        assertEquals(circle.get(1).intValue(),56);
        assertEquals(circle.get(2).intValue(),57);
        assertEquals(circle.size(), 3);
        assertEquals(circle.current().intValue(),57);        
    }
